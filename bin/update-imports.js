...
var packages = ["packages/node-deepresearch", "packages/jina-ai"];
...
for (var _i = 0, packages_1 = packages; _i < packages_1.length; _i++) {
  ...
  for (
    var _a = 0, sourceFiles_1 = sourceFiles;
    _a < sourceFiles_1.length;
    _a++
  ) {
    ...
    for (
      var _b = 0, importDeclarations_1 = importDeclarations;
      _b < importDeclarations_1.length;
      _b++
    ) {
      ...
      console.log(
        "  Updated import: "
          .concat(moduleSpecifier, " -> ")
          .concat(finalModuleSpecifier),
      );
    }
