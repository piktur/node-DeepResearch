...
import { RateLimitTriggeredError } from "#src/lib/errors.js";
...
export class RateLimitControl extends AsyncService {
  ...
  rateLimitDescToCriterion(rateLimitDesc: RateLimitDesc) {
    return [
      new Date(Date.now() - rateLimitDesc.periodSeconds * 1000),
      rateLimitDesc.occurrence,
    ] as [Date, number];
  }
